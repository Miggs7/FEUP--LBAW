    ...
    <div class="col">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="{{url('/user/'.$auctioneer_id)}}" style="text-decoration: none">
          ...
          <div class="d-flex auction justify-content-center align-items-center">
            ...
            {{--this should only appear if ongoing--}}
              ...
              <form id="bidForm" method="POST" action={{url('/auction/'.$id.'/bid')}}>
                  @csrf
                  @method('PUT')
                  ...
                  <div class="input-group mb-3">
                    ...
                    <span class="error text-danger">
                        You need to authenticate to bid!
                    </span>
                    @endif
                    @if ($errors->has('id_bidder') && !$errors->has('id_bidder'))
                    <span class="error text-danger">
                        Your bid is too low!
                    </span>
                    @endif
            ...
            <span id="watchLogin" class="text-danger" style="display:none">Please Authenticate to Watch!</span>
          </div>
        </div>
      </div>
    </div>
